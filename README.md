...
- Enabled data-driven decision-making and performance monitoring  

### Soil Health & Fertilizer Prediction
- Built a *stacked ML model* for fertilizer classification  
- Applied *SMOTE & feature engineering* for improved accuracy  
- Visualized insights using *Power BI dashboards*  

### AI Voice Interface for Nutrition Guidance
- Developed a *voice-enabled AI system* using LLMs & speech technologies  
- Enabled *real-time personalized diet recommendations*  
- Designed smooth conversational user interaction  
...
### Core Concepts
DSA DBMS OOPs Operating Systems
